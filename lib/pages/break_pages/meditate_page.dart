...
import 'package:morie/pages/break_pages/meditate_second_page.dart';
        ...
        child: SingleChildScrollView(
            ...
            child: Column(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MeditateSecondPage()),
                );
              },
                child: Center(
                  child: Row(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      flex: 3,
                      child: Padding(
                        padding: EdgeInsets.only(left: 27, right: 38),
                        child: Column(
                          children: [
                            Text(
                              '1-Hour Meditation',
