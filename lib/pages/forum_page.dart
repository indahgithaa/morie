...
class ForumPage extends StatelessWidget {
  List<Topic> topics = [
    Topic('@emma3113', 'lib/assets/mom_profpic.png', 'my toddler stories!', 'diaper rash', 'my son got a severe diaper rash. how to get rid of it? any tips?', ''),
    Topic('@sitied', 'lib/assets/sitied_profpic.png', 'soon to be mom', 'Pregnancy Update, Yoga stuff.', 'Just wanted to share a little snippet of my pregnancy journey intertwined with the soothing embrace of yoga. These prenatal yoga sessions have become my sanctuary, a sacred time where I connect with both my body and the tiny soul growing within.', 'lib/assets/yoga_pic.png'),
    Topic('@mum', 'lib/assets/mum_profpic.png', 'Average housewife', 'Delicious healthy recipe for mom! :D', 'Just wanted to drop a quick note from the heart of daily homemaker life. Juggling chores, meals, and the never-ending laundry feels like a marathon sometimes, but there\'s a unique magic in it all. From the sizzling sounds in the kitchen to the cozy chaos of family life, these are the real moments that make a home.', ''),
  ];
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage('lib/assets/mom_profpic.png'),
                          ),
                        ),
                      ),
                      Container(
