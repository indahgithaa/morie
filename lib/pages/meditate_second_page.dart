...
class MeditateSecondPage extends StatefulWidget {
  const MeditateSecondPage({super.key});

  @override
  State<MeditateSecondPage> createState() => _MeditateSecondPageState();
}

class _MeditateSecondPageState extends State<MeditateSecondPage> {
